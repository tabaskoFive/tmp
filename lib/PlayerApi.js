...
exports.default = (function (deps) { return function (server, opts) {
    var rootPath = 'player';
    ...
    server.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, RTE.run(getPlayer, deps)
                        .then(E.fold(function (e) { return res.send(e); }, function (b) { return res.send("ok" + b); }))];
